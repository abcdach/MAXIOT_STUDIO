				...
				case 0://"DATA STREAM"
					...
					//#--------------------------------------------------------------	Print_Data_Stream_1(DATA[3]);		  
						switch (S_Value) {
							...
							case 2: if (typeof Print_Data_Stream_2 !== "undefined") var DEC = Base64.decode(V_Value);Print_Data_Stream_2(DEC);break;
